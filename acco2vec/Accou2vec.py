...
class Accou2vec():
    ...
    def __init__(self, osn_input_file, emb_output_file, p=1, q=1, r=1, w=20, l=200, neg=5, d=128, window_size=7,
    ...
    def __extract_community_structure(self):
        ...
        print(self.node_community_dict)
        self.community_node_dict = {}
        ...
        print(self.community_node_dict)
        # with open('twibot.menbership.json', 'r', encoding='utf8')as fp:
        ...
        # self.community_node_dict = dict
        # self.node_community_dict = community_louvain.best_partition(self.osn.to_undirected())
        # # print(self.community_node_dict.keys())
    ...
    def __get_community_idx(self, node_id):
        '''print(node_id)
        print(self.node_community_dict)
        print(self.node_community_dict[node_id])'''
    ...
    def __accou2vec_random_walk(self, start_node):
    ...
    def __generate_walks(self):
        ...
        for walk_iter in range(self.w):
            ...
            for node in nodes:
                self.walks.append(self.__accou2vec_random_walk(start_node=node))
...
def main():
    ...
    osn_input_file = 'cresci-2015.edgelist.txt'
   
    emb_output_file = 'test0605.emb'
    accou2vec = Accou2vec(osn_input_file, emb_output_file)
    accou2vec.train()
